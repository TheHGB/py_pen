# Get it?, because it is a sniffer (kys)
# With this one you'll only analyze the first packet you intercept and the analysis will only be correct if the packet is TCP and the headers don't have any special option enabled
